# Project 3 - *TwitterPlus*

**TwitterPlus** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='./twitterAppRecord.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
